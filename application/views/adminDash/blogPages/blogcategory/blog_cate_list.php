                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="<?php echo base_url('admin_blog_category'); ?>" style="float: right">
                                <button class="btn btn-warning" style="margin-right: 10px;">Exit</button>
                            </a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped text-white">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-left"> Blog Info Link </th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($item['blog_file']){ ?>
                                                    ...
                                                    <img style="object-fit: cover; width: 40px; height: 40px;" src="<?php echo base_url('uploads/blogcate/'.$item['blog_file']); ?>">
                                                <?php }else{ ?>
