                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Gallery Client Section</h4>
                                <form action="<?php echo base_url('admin_gall_client_add_act'); ?>" method="post" class="forms-sample" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="secondary_title" class="form-control" id="exampleInputEmail1" required>
                                    </div>
