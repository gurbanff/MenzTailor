                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Client FeedBack Image</h4>
                                <form action="<?php echo base_url('admin_c_feed_img_edit_act/'.$fileUp['id']); ?>" method="post" class="forms-sample" enctype="multipart/form-data">

                                    <div class="form-group">
                                        <div class="input-group col-xs-12">
                                            <label for="click">
                                                <i class="mdi mdi-image-area text-white" style="font-size: 60px;"></i>
                                                <input type="file" name="user_file" id="click" hidden>
                                            </label>
                                        </div>

                                        <?php if($fileUp['file']){ ?>
                                            <img style="object-fit: cover; width: 40px; height: 40px;" src="<?php echo base_url('uploads/clientfeedback/'.$fileUp['file']); ?>">
                                        <?php }else{ ?>
