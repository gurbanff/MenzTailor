                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?php echo base_url('admin_clients_offers_upt_act/'.$select_upt_clients['id']); ?>" method="post" class="forms-sample" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Banner Item1</label>
                                        <input type="text" name="fadeinup" class="form-control" id="exampleInputUsername1" value="<?php echo $select_upt_clients['fade_in_up']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Banner Item2</label>
                                        <input type="text" name="fadeindown" class="form-control" id="exampleInputEmail1" value="<?php echo $select_upt_clients['fade_in_down']; ?>" required>
                                    </div>
