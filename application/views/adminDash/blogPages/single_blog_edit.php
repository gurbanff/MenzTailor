        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <a href="<?php echo base_url('admin_single_blog_list'); ?>">
                                <button class="btn btn-dark float-right">Exit</button>
                            </a>
                            <h4 class="card-title">Banner Section</h4>
                            <form action="<?php echo base_url('admin_single_blog_edit_act/'.$select_blog_upt['id']); ?>" method="post" class="forms-sample" enctype="multipart/form-data">
                                ...
                                <?php if($select_blog_upt['blog_file']){ ?>
                                    <img style="object-fit: cover; width: 40px; height: 40px;" src="<?php echo base_url('uploads/singleblogimg/'.$select_blog_upt['blog_file']); ?>">
                                <?php }else{ ?>
