                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('admin_cont_location_edit_act/'.$select_cont_upt['id']); ?>" method="post" class="forms-sample" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="exampleInputUsername1">Country Name</label>
                                    <input type="text" name="country" class="form-control" id="exampleInputUsername1" value="<?php echo $select_cont_upt['country']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleTextarea1">Location HTML Code</label>
                                    <textarea name="location" class="form-control" id="exampleTextarea1" rows="12"><?php echo $select_cont_upt['location']; ?></textarea>
                                </div>
