        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <a href="<?php echo base_url('admin_gall_banner_add'); ?>" style="float: right">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped text-white">
                                    ...
                                    <?php foreach($select_gall_data as $item){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <?php if($item['gall_file']){ ?>
                                                    <img style="object-fit: cover; width: 40px; height: 40px;" src="<?php echo base_url('uploads/gallbanner/'.$item['gall_file']); ?>">
                                                <?php }else{ ?>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?php echo base_url('admin_gall_banner_edit/'.$item['id']); ?>">
                                                    <button class="btn btn-info">Edit</button>
                                                </a>

                                                <a onclick="return confirm('Do you want to delete it?')" href="<?php echo base_url('admin_gall_banner_del/'.$item['id']); ?>">
