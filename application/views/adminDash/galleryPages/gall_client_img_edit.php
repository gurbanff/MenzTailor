                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?php echo base_url('admin_gall_client_img_edit_act/'.$select_gall_client_img['id']); ?>" method="post" class="forms-sample" enctype="multipart/form-data">
                                    ...
                                    <?php if($select_gall_client_img['client_img']){ ?>
                                        <img style="object-fit: cover; width: 40px; height: 40px;" src="<?php echo base_url('uploads/gallclient/'.$select_gall_client_img['client_img']); ?>">
                                    <?php }else{ ?>
