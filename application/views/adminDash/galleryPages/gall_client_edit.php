                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?php echo base_url('admin_gall_client_edit_act/'.$select_gall_upt['id']); ?>" method="post" class="forms-sample" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Client Title</label>
                                        <input type="text" name="title" class="form-control" id="exampleInputUsername1" value="<?php echo $select_gall_upt['title']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Client Title 2nd</label>
                                        <input type="text" name="secondary_title" class="form-control" id="exampleInputEmail1" value="<?php echo $select_gall_upt['secondary_title']; ?>" required>
                                    </div>
