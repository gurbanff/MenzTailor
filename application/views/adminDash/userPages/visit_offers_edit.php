                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?php echo base_url('admin_visit_offers_edit_act/'.$select_off_upt['id']); ?>" method="post" class="forms-sample" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Percent</label>
                                        <input type="text" name="hpercent" class="form-control" id="exampleInputUsername1" value="<?php echo $select_off_upt['hpercent']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Button</label>
                                        <input type="text" name="visit_button" class="form-control" id="exampleInputEmail1" value="<?php echo $select_off_upt['visit_button']; ?>" required>
                                    </div>
                                    ...
                                    <?php if($select_off_upt['user_file']){ ?>
                                        <img style="object-fit: cover; width: 40px; height: 40px;" src="<?php echo base_url('uploads/visitimg/'.$select_off_upt['user_file']); ?>">
                                    <?php }else{ ?>
