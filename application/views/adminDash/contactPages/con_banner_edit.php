            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <a href="<?php echo base_url('admin_con_banner_list'); ?>">
                                    <button class="btn btn-dark float-right">Exit</button>
                                </a>
                                <h4 class="card-title">Banner Section</h4>
                                <form action="<?php echo base_url('admin_con_banner_edit_act/'.$select_con_upt['id']); ?>" method="post" class="forms-sample" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Banner Title</label>
                                        <input type="text" name="title" class="form-control" id="exampleInputUsername1" value="<?php echo $select_con_upt['title']; ?>" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group col-xs-12">
                                            <label for="click">
                                                ...
                                                <input id="click" name="con_file" type="file" class="form-control file-upload-info" hidden>
                                            </label>
                                        </div>
                                    </div>

                                    <?php if($select_con_upt['con_file']){ ?>
                                        <img style="object-fit: cover; width: 40px; height: 40px;" src="<?php echo base_url('uploads/contact/'.$select_con_upt['con_file']); ?>">
                                    <?php }else{ ?>
