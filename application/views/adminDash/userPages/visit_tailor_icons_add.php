                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Icon Section</h4>
                                    <form action="<?php echo base_url('admin_visit_tailor_icon_add_act'); ?>" method="post" class="forms-sample" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="icon" class="form-control" id="exampleInputUsername1" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Icon Https</label>
                                            <input type="text" name="icon_https" class="form-control" id="exampleInputUsername1" required>
                                        </div>
