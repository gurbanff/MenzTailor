    ...
    <div class="preloader d-flex align-items-center justify-content-center">
        <div class="preloader-inner position-relative">
            ...
            <div class="preloader-img pere-text">
                <img src="<?php echo base_url('public/userview/'); ?>assets/img/logo/logo.png" alt="">
            </div>
        </div>
    </div>
</div>
...
<header>
    ...
    <div class="header-area header-sticky">
        <div class="header-wrapper d-flex flex-wrap align-items-center justify-content-between">
            <!-- Logo -->
            <div class="logo">
                <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url('public/user/'); ?>assets/img/logo/logo.png" alt=""></a>
            </div>
            <!-- Main-menu -->
            ...
            <div class="d-none d-xl-block">
                <a href="<?php echo base_url('Contact'); ?>" class="btn btn2">
