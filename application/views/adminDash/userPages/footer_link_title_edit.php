                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Links Section: Title</h4>
                                    <form action="<?php echo base_url('admin_footer_link_title_edit_act/'.$select_links_upt['id']); ?>" method="post" class="forms-sample" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Links Title</label>
                                            <input type="text" name="title" class="form-control" id="exampleInputUsername1" value="<?php echo $select_links_upt['title']; ?>" required>
                                        </div>
